...
public class F_PlayerMovement : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        //Why even use Rigidbody if you choose to move it with linearVelocity?? This is dumb
    ...
    {
        movementVector = Vector3.zero; //There is no reason to have 2 different vectors for checking input
    }
